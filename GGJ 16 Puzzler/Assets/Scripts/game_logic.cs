    ...
    void CalculateStock (int corp)
    {
        if (credibilities[corp]<15)
        {
            ...
            for (int i=0; i<=3; i++)
            {
                if (i!= corp)
                {
                    if (stock_share[i]<=98) { stock_share[i] = stock_share[i] + 2; }
                    else if (stock_share[i]==99) { stock_share[i] = stock_share[i]++; stock_share[corp]++; }
                    else { stock_share[corp] = stock_share[corp] + 2; }
        ...
        else if (credibilities[corp] < 25)
        {
            ...
            for (int i = 0; i <= 3; i++)
            {
                if (i != corp)
                {
                    if (stock_share[i] < 100) { stock_share[i] = stock_share[i] + 1; }
                    else { stock_share[corp] = stock_share[corp] + 1; }
                }
            }
        }
        ...
        else if (credibilities[corp] < 50)
        {
            ...
            for (int i = 0; i <= 3; i++)
            {
                if (i != corp)
                {
                    if (stock_share[i] > 1) { stock_share[i] = stock_share[i] + 1; }
                    else { stock_share[corp] = stock_share[corp] - 1; }
                }
            }
        }
        else if (credibilities[corp] < 66)
        {
            ...
            for (int i = 0; i <= 3; i++)
            {
                if (i != corp)
                {
                    if (stock_share[i] >= 2) { stock_share[i] = stock_share[i] - 2; }
                    else if (stock_share[i] == 1) { stock_share[i] = stock_share[i]--; stock_share[corp]--; }
                    else { stock_share[corp] = stock_share[corp] - 2; }
                }
            }
        }
        else if (credibilities[corp] < 75)
        {
            ...
            for (int i = 0; i <= 3; i++)
            {
                if (i != corp)
                {
                    if (stock_share[i] >= 3) { stock_share[i] = stock_share[i] - 3; }
                    else if (stock_share[i]==2) { stock_share[i] = stock_share[i] - 2; stock_share[corp]--; }
                    else if (stock_share[i] == 1) { stock_share[i] = stock_share[i]--; stock_share[corp]=stock_share[corp]-2; }
                    else { stock_share[corp] = stock_share[corp] - 3; }
                }
            }
        }
        else if (credibilities[corp] <= 100)
        {
            ...
            for (int i = 0; i <= 3; i++)
            {
                if (i != corp)
                {
                    if (stock_share[i] >= 4) { stock_share[i] = stock_share[i] - 4; }
                    else if (stock_share[i]==3) { stock_share[i] = stock_share[i] - 3; stock_share[corp]--; }
                    else if (stock_share[i] == 2) { stock_share[i] = stock_share[i] - 2; stock_share[corp]=stock_share[corp]-2; }
                    else if (stock_share[i] == 1) { stock_share[i] = stock_share[i]--; stock_share[corp] = stock_share[corp] - 3; }
                    else { stock_share[corp] = stock_share[corp] - 4; }
                }
            }
        }
    }
